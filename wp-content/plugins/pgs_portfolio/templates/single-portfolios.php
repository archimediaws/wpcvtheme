	...
	<div class="container-fluid">		
		...
		<div class="row">
				...
				<div class="owl-carousel-1">						
					<?php if(!empty($portfolio_images)):?>
						<?php foreach($portfolio_images as $images):?>
								<div class="item">
									<img alt="" src="<?php echo esc_url(@$images['sizes']['portfolio-slider']);?>">
								</div>
						<?php endforeach;?>
					<?php endif;?>
				</div>				
			...
			<div class="col-lg-5 col-md-5 clearfix">
				...
				<div class="tags-2">
					<h5><?php esc_html_e( 'Tags:', 'pgs_portfolio' );?></h5>					
					<ul>
				...
				<div class="port-meta clearfix"> <!-- get meta data -->
					<ul>
						...
						?>						
						<?php if(@$release):?>
						<li><b><?php esc_html_e('Release:','pgs_portfolio'); ?></b><span><?php echo date('d/m/Y',strtotime($release));?> </span></li>
						<?php endif;?>
						
						<?php if(@$client_name):?>
						<li><b><?php esc_html_e('Client:','pgs_portfolio');?></b><span><?php echo esc_attr($client_name);?></span></li>
						<?php endif;?>
						
						<?php if(@$project_url):?>
						<li><b><?php esc_html_e('Live Demo:','pgs_portfolio');?> </b><span><?php echo esc_attr($project_url);?></span></li>						
						<?php endif;?>
						
						<?php if(!empty($skills)):?>
						<li><b><?php esc_html_e('Skills:','pgs_portfolio');?> </b><span><?php echo implode(', ',$skills); ?></span></li>
						<?php endif;?>
					</ul>
				</div>
